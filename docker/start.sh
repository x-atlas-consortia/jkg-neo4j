...
echo " "
echo "*****************************"
echo "JSON Knowledge Graph (JKG) neo4j start script"
...
# Wait until all indexes have been built before moving on to other tasks, such as setting the server to read-only.
